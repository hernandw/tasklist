 ...
 */ (function (e) {
  ...
  function E(x, T) {
    ...
    try {
      for (
        d(T), m = t(s);
        m !== null && (!(m.expirationTime > T) || (x && !Ne()));

      ) {
        var H = m.callback;
        if (typeof H == "function") {
          (m.callback = null), (p = m.priorityLevel);
          var G = H(m.expirationTime <= T);
          (T = e.unstable_now()),
      ...
      if (m !== null) var bt = !0;
        ...
        var vn = t(c);
        vn !== null && yl(v, vn.startTime - T), (bt = !1);
      }
      return bt;
    } finally {
      (m = null), (p = z), (g = !1);
...
function Bc(e, n, t, r, l, o, i, u, s) {
  (xt = !1), (Rr = null), Ac.apply(Vc, arguments);
}
...
function bo(e, n, t, r) {
  if (Mr) {
    var l = co(e, n, t, r);
    if (l === null) Dl(e, n, r, Ir, t), Yi(e, r);
...
var kf = V({}, Zt, {
  ...
  zf = we(Tf),
  Lf = [9, 13, 27, 32],
  ri = He && "CompositionEvent" in window,
  Ct = null;
He && "documentMode" in document && (Ct = document.documentMode);
var Rf = He && "TextEvent" in window && !Ct,
  Is = He && (!ri || (Ct && 8 < Ct && 11 >= Ct)),
...
for (var Rl = 0; Rl < uu.length; Rl++) {
  var jl = uu[Rl],
    Hf = jl.toLowerCase(),
    Qf = jl[0].toUpperCase() + jl.slice(1);
  pn(Hf, "on" + Qf);
}
...
function od(e, n, t) {
  ...
  if (Na(e)) Pa(n, l);
    ...
    (t = ra(e, n, l, r)),
      t !== null && ((l = ie()), je(t, e, r, l), Ta(t, n, r));
  }
}
function Na(e) {
  var n = e.alternate;
...
function zu(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Nr(e, n), ia(n, t, r), Co(n, t, r, l), (r = !0);
  else if (e === null) {
    var i = n.stateNode,
      u = n.memoizedProps;
    i.props = u;
...
function Aa(e) {
  ...
  n !== null && ((e.alternate = null), Aa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[go], delete n[qf], delete n[bf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function je(e, n, t, r) {
  ...
  Gt(e, t, r),
    (!(j & 2) || e !== J) &&
      ...
      pe(e, r),
      t === 1 && j === 0 && !(n.mode & 1) && ((lt = Q() + 500), il && hn()));
}
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Ki(t), n === 1))
      e.tag === 0 ? ed(Uu.bind(null, e)) : bs(Uu.bind(null, e)),
        Zf(function () {
          !(j & 6) && hn();
        }),
        (t = null);
...
function Qa(e, n) {
  if (((Pr = -1), (Tr = 0), j & 6)) throw Error(y(327));
  var t = e.callbackNode;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), pe(n, Q()), !(j & 6) && ((lt = Q() + 500), hn()));
      }
      break;
    case 13:
      Ln(function () {
...
gs = _i;
ws = Ln;
var jd = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, vs, ys, _i] },
  yt = {
...
var rc = { exports: {} },
  Id = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",
  Fd = Id,
  Ud = Fd;
function lc() {}
function oc() {}
...
const Vd = Wu(Ad),
  ic = ({ task: e }) => {
    const [n, t] = _n.useState(e.description),
      r = async (l) => {
        l.preventDefault();
        try {
          const o = { description: n };
          await fetch(`https://tasklist-9x1n.onrender.com/${e.id}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
...
ic.propTypes = { task: Vd.object.isRequired };
const Bd = () => {
    const e = "https://tasklist-9x1n.onrender.com/tasks",
      [n, t] = _n.useState([]),
      r = (o) => {
        try {
          fetch(`${e}/${o}`, { method: "DELETE" }),
            t(n.filter((i) => i.id !== o));
        } catch (i) {
        ...
        P.jsxs("table", {
          ...
          children: [
            P.jsx("thead", {
              children: P.jsxs("tr", {
                children: [
                  P.jsx("th", { scope: "col", children: "Descripcion" }),
                  P.jsx("th", { colSpan: "2", children: "Acciones" }),
                ],
              }),
            }),
            P.jsx("tbody", {
              children: n.map((o) =>
                P.jsxs(
                  ...
                  {
                    children: [
                      P.jsx("td", { children: o.description }),
                      P.jsx("td", {
                        children: P.jsx("div", {
                          children: P.jsx("div", {
                            className: "btn btn-primary",
                            children: P.jsx(ic, { task: o }),
                          }),
                        }),
                      }),
                      P.jsx("td", {
  ...
  Wd = () =>
    P.jsxs("div", {
      className: "container",
      children: [P.jsx(Md, {}), P.jsx(Bd, {})],
    });
Ql.createRoot(document.getElementById("root")).render(
  P.jsx(xc.StrictMode, { children: P.jsx(Wd, {}) })
);
